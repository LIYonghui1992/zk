...
//        'type'  => 'test', //如果这样则阻止了自动生成日志
    ...
    //微信公众号共用的微信配置 放在外面
    'wx'=>[
        'token'=>'deaba2917a67eeac031fb5629520ac90', //test token is the same with formal token
        'EncodingAESKey'=>'EuEJrckUHoYv74MaDQmIZReiSIe18kgtvmzAwIKpX3Y',
        //正式账号
        'appId'=>'wx5b3e524297b79cbb',
        'appSecret'=>'cae933c0f6765a5119bb63969d277ef8',
        //测试账号
//        'appId'=>'wx6e6f7c108d158292',
//        'appSecret'=>'d86b82a37ff39862771e41ff3a2b0216',
        ...
        'refresh_tmptoken_url'=>'https://api.weixin.qq.com/sns/oauth2/refresh_token?appid=%s&grant_type=refresh_token&refresh_token=%s',
        'snsuser_url'=>'https://api.weixin.qq.com/sns/userinfo?access_token=%s&openid=%s&lang=zh_CN',
    ],
];
